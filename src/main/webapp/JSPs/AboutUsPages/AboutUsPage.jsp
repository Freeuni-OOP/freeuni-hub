        ...
        <div class="col-lg-6 col-md-6 col-12 order-1 order-md-2">
            <div class="section-title ml-lg-5">
                ...
                <p class="text-muted mb-0"> <!-----------------------text------------->
                    ეს საიტი მაქსელების: გიორგი ადიკაშვილის, ლუკა მაჭარაშვილის, ლუკა სამხარაძისა და დავით ხვედელიძის მიერ
                ...
                <div class="row">
                    <div class="col-lg-6 mt-4 pt-2">
                        <div class="media align-items-center rounded shadow p-3">
                            ...
                            <h6 class="ml-3 mb-0"><a href="https://www.facebook.com/giorgi.adikashvili.7/" class="text-dark"> გვერდის ავტორი </a></h6>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 mt-4 pt-2">
                        <div class="media align-items-center rounded shadow p-3">
                            ...
                            <h6 class="ml-3 mb-0"><a href="../../JSPs/ContactPages/ContactPage.jsp" class="text-dark"> კონტაქტი </a></h6>
                        </div>
                    </div>
